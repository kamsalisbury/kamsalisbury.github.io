Log aggregators are an important part of management, compliance and monitoring. The powerful utility [NXLOG Community Edition](https://nxlog.co/products/nxlog-community-edition) is an excellent solution for receiving syslog messages from 1+ hosts and can even receive (and send) TCP SSL messages.
